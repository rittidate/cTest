...
void readEntireFile(){
	...
	fp = fopen("/Users/Capuchino/Dev/c/cTest/13_01_File/message1301", "r"); // Change to match your path
	ch = getc(fp);
...
void writeToFile(){
	FILE *fp;  // pointer to a file type
	fp = fopen("/Users/Capuchino/Dev/c/cTest/13_01_File/message2", "w"); // Change to match your path
	char name[10] = "Roger";
